...
<head>
    ...
    <title>Saffron Hotel Unawatuna</title>
    <!-- Bootstrap CSS -->
...
<header class="header_area">
    <div class="container">
        <nav class="navbar navbar-expand-lg navbar-light">
            ...
            <a class="navbar-brand logo_h" href="{{asset('/')}}"><img width="10%" src="{{asset('/images/logos/logo_black_name.png')}}" alt=""></a>
            ...
            <div class="collapse navbar-collapse offset" id="navbarSupportedContent">
                <ul class="nav navbar-nav menu_nav ml-auto">
                    ...
                    <li class="nav-item"><a class="nav-link" href="{{asset('/accomodation')}}">Accomodation</a></li>
                    ...
                    <li class="nav-item">
                        @if(Auth::user())
                            <a class="nav-link" href="{{asset('/dashboard')}}">{{Auth::user()->name}}</a>
                        @else
        ...
        <div class="row footer-bottom d-flex justify-content-between align-items-center">
            <p class="col-lg-8 col-sm-12 footer-text m-0">
                ...
                All rights reserved | This site is made with <i class="fa fa-heart-o" aria-hidden="true"></i> by <a
                    href="https://loopy.lk" target="_blank">Loopy</a>
             </p>
